...
public class DownloadManager {
    ...
    func upload(image: UIImage, completion: @escaping ((String?) -> ())) {
        ...
        }, to: "https://3dke7yk5g5hlo2nhfinpnbf3h40mauci.lambda-url.us-east-1.on.aws", method: .post, headers: headers).responseDecodable(of: [UploadResponse].self) { response in
